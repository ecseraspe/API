// ---------------------------------------------------------------------------------------------------
// <copyright file="G2SResponse.cs" company="Youffer">
//     Copyright (c) 2014 All Right Reserved
// </copyright>
// <author>Gaurav Barar</author>
// <date>2014-12-28</date>
// <summary>
//     The G2SResponse class
// </summary>
// ---------------------------------------------------------------------------------------------------
...
namespace Youffer.DataService.DBSchema
{
    ...
    /// </summary>
    [Table("G2SResponse")]
    public class G2SResponse
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="G2SResponse" /> class.
        /// </summary>
        public G2SResponse()
        {
