// ---------------------------------------------------------------------------------------------------
// <copyright file="Repository.cs" company="Youffer">
...
namespace Youffer.DataService
{
    ...
    public class Repository<T> : IRepository<T> where T : class
    {
        ...
        public virtual bool Commit()
        {
            try
            {
                return this.dataBaseContext.SaveChanges() > 0;
            }
            catch (Exception ex)
            {
        ...
        public void Update(T entity)
        {
            ...
            {
                object pkey = this.dataBaseSet.Create().GetType().GetProperty("RepositoryId").GetValue(entity);
