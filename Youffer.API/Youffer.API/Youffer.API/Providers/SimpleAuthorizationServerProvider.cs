// ---------------------------------------------------------------------------------------------------
// <copyright file="SimpleAuthorizationServerProvider.cs" company="Youffer">
...
namespace Youffer.API.Providers
{
    ...
    public class SimpleAuthorizationServerProvider : OAuthAuthorizationServerProvider, IDisposable
    {
        ...
        public override Task ValidateClientAuthentication(OAuthValidateClientAuthenticationContext context)
        {
            ...
            ClientDto client = this.authRepository.FindClient(context.ClientId);
        ...
        /// The default behaviour is to reject this grant type.
        ...
        public override async Task GrantResourceOwnerCredentials(OAuthGrantResourceOwnerCredentialsContext context)
        {
            ...
            ApplicationUserDto user = await this.authRepository.FindUser(context.UserName, context.Password);
            if (user == null)
            {
            ...
            ////Update IsOnline in CRM
            ////OrganisationModel orgModel = this.crmManagerService.GetOrganisation(user.Id);
            ////orgModel.IsOnline = true;
            ////orgModel = this.crmManagerService.UpdateOrganisation(user.Id, orgModel);
